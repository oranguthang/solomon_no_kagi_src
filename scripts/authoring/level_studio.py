...
from scripts.authoring.level_editor import (
    DOCUMENT_SCHEMA,
    KEY_STATUS_BITS,
    POSITION_FIELDS,
    ROOM_COUNT,
...
from scripts.authoring.level_preview import (
    BONUS_ROOM_INDEX,
    METATILE_SIZE,
    ROOM_MAP_EMPTY,
    LevelPreviewError,
...
from scripts.authoring.room_data import (
    ENEMY_TYPE_MAXIMUM,
    ENEMY_TYPE_MINIMUM,
...
LEVEL_PLAYTEST_LUA = ROOT / "scripts" / "runtime" / "level_playtest.lua"
EDIT_MODES = (
    "select",
    "brown block",
    "white block",
