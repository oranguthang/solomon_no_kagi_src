...
_label_bank0_8640:
    ...
    LDA ($08),Y
    CMP #$C0
    BCC _label_bank0_8679
    INY
    LDA ($08),Y
    TAX
    INY
    CMP ($08),Y
    BEQ _label_bank0_8665
    STA ($08),Y
    INY
    LDA ($08),Y
    INY
    BPL _label_bank0_866d
...
_label_bank0_8679:
    DEC $0D
    BPL _label_bank0_8640
    LDA $058A
    AND #$0F
    BEQ _label_bank0_8688
    LDA #$00
    STA $20
...
_label_bank0_8688:
    ...
    STA $0A
    ASL A
    BCC _label_bank0_8699
    TAX
    CLC
    ADC #$06
    BVC _label_bank0_8699
    TXA
...
_label_bank0_8725:
    ...
    LDA $0304,Y
    CLC
    BPL _label_bank0_8734
    SEC

_label_bank0_8734:
    ROR $0A
    LDA $0C
    BMI _label_bank0_873b
    INY

_label_bank0_873b:
    LDA $0304,Y
    BPL _label_bank0_8741
    SEC
...
_label_bank0_874d:
    LDA $0304,Y
    BPL _label_bank0_8753
    SEC

_label_bank0_8753:
    ROR $0A
    LDA $0C
    BMI _label_bank0_875a
    DEY

_label_bank0_875a:
    LDA $0304,Y
    BPL _label_bank0_8760
    SEC
...
_label_bank0_876c:
    LDA $0304,Y
    BPL _label_bank0_8772
    SEC

_label_bank0_8772:
    ROR $0A
    LDA $0C
    BMI _label_bank0_8779
    INY

_label_bank0_8779:
    LDA $0304,Y
    BPL _label_bank0_877f
    SEC
...
; jump table addresses
    .byte $26, $88, $43, $88, $a5, $88, $82, $89, $49, $89, $f6, $89, $d6
    .byte $89, $fe, $89, $e1, $88, $b8, $89, $0b, $8a, $13, $8a, $90, $89, $20, $8a, $2a
    .byte $8a, $26, $88
    ...
    SBC #$0C
    CMP #$0C
    BCS _label_bank0_8842
    LDA $0E
    AND #$30
    BNE _label_bank0_8842
    LDA #$03
    AND $0F
    ORA #$18
    LDY #$03
...
_label_bank0_8981:
    ...
    SBC #$10
    CMP #$08
    BCC _label_bank0_89ad
    AND #$FC
    CMP #$0C
    BEQ _label_bank0_89ad
    TXA
    AND #$03
    ORA #$06
    LDY #$03
...
_label_bank0_89ad:
    ...
    SBC #$10
    CMP #$08
    BCC _label_bank0_89d5
    LDY #$05
    LDA ($08),Y
    ASL A
    BMI _label_bank0_89d5
    LDA #$09
    LDY #$03
    STA ($08),Y
...
_label_bank0_89d5:
    ...
    SBC #$10
    CMP #$08
    BCC _label_bank0_89f5
    LDX #$0A
    LDY #$05
    LDA ($08),Y
    ASL A
    BMI _label_bank0_89f5
    LDA #$08
    LDY #$03
    STA ($08),Y
...
; jump engine
    ...
    .byte $0f, $26, $29, $30, $0f, $30, $16, $27, $0f, $16, $10, $30, $0f, $2c, $26, $30
    .byte $00
...
_label_bank0_8f1e:
    ...
    STA $04F7,Y
    DEY
    BPL _label_bank0_8f1e
    LDX $28
    TXA
    LDY #$01
    AND #$40
    BEQ _label_bank0_8f34
    LDY #$05
...
_label_bank0_8f5f:
    ...
    LDA $8FAA,Y
    DEY
    BPL _label_bank0_8f5f
    DEX
    BPL _label_bank0_8f47
    LDX #$02
...
_label_bank0_8fc6:
    ...
    INX
    DEY
    BNE _label_bank0_8fbc
    BCS _label_bank0_8fe4
    LDA $0438
    SBC #$01
    TAX
    TYA
...
_label_bank0_9003:
    LDA $0438,X
    BNE _label_bank0_900e
    BCS _label_bank0_900f
    LDA #$24
    BPL _label_bank0_900f
...
_label_bank0_900f:
    ...
    LDX #$32
    CMP #$30
    BEQ _label_bank0_9042
    CMP #$20
    BCC _label_bank0_9041
    INX
...
_label_bank0_90a3:
    ...
    STA $03E6,X
    DEX
    BPL _label_bank0_90a3
    LDX $0428
    LDA #$30
    AND $78
    BEQ _label_bank0_90c2
    LDY $0429
    STY $0428
    DEY
    CMP #$30
    BNE _label_bank0_90c2
    TYA
    TAX
...
_label_bank0_90f8:
    ...
    LDA $911E,Y
    DEY
    BPL _label_bank0_90f8
    INY
    STY $0593
    LDA $78
    ROR A
    BCC _label_bank0_9114
    INY
    LDA $0429
    BEQ _label_bank0_9111
    INY
...
_label_bank0_9148:
    STA $78,X
    DEX
    BNE _label_bank0_9148
    LDX #$08

_label_bank0_914f:
    STA $0449,X
    DEX
    BNE _label_bank0_914f
    INX
    STX $78
    STX $80
    STX $0433
...
_label_bank0_9179:
    ...
    LDY #$05
    LDA ($30),Y
    BEQ _label_bank0_91ea
    STA $02
    LDX #$02
    INY
    LDA ($30),Y
    BNE _label_bank0_91ca
    LDX #$35
...
_label_bank0_922e:
    ...
    INY
    CPY #$08
    BNE _label_bank0_922e
    LDX $0429
    BNE _label_bank0_9243
    LDX $0428
    INX
...
_label_bank0_9268:
    ...
    STA $0593,X
    DEX
    BPL _label_bank0_9268
    RTS

    .byte $21
    .byte $6b, $45, $1c, $11, $1b, $12, $17, $0e, $21, $cb, $47, $24, $1b, $18, $18, $16
    .byte $24, $00, $00, $22, $6f, $42, $98, $00, $00, $00, $c0, $04, $ff, $0e, $19, $1b
    .byte $12, $17, $1c, $0e, $1c, $1c, $24, $1c, $18, $15, $18, $16, $18, $17, $24, $11
    .byte $12, $0d, $0d, $0e, $17, $24
...
_label_bank0_92ac:
    CMP #$0A
    BCC _label_bank0_92b5
    SBC #$0A
    INX
    BNE _label_bank0_92ac

_label_bank0_92b5:
    CPX #$00
    BNE _label_bank0_92bb
    LDX #$24
...
_label_bank0_939f:
    ...
    STA $04FF,X
    DEX
    BPL _label_bank0_939f
    CLC
    LDA $0503
    ADC $80
    AND #$3F
    STA $0503
    BPL _label_bank0_9363
    LDX #$0E
    STX $06
    LDA $04FF
    STA $04
