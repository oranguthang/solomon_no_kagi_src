...
from scripts.authoring import audio_preview
from scripts.authoring import sound_studio
from scripts.authoring.audio_data import (
    AUDIO_STREAM_DATA,
    EUROPE_LAYOUT,
    AudioCommand,
    AudioStream,
...
from scripts.build.revision_profiles import get_profile, load_profiles
...
class AudioDataTests(unittest.TestCase):
    ...
    def test_source_uses_symbolic_audio_pointers(self) -> None:
        ...
        from scripts.authoring.room_data import extract_prg
