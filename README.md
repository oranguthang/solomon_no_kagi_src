...
src/game/nmi/             gameplay interaction and Dana/OAM frame services
src/game/enemies/         enemy lifecycle plus five cohesive AI families
src/game/objects/         object update pipeline and collision/motion responses
src/game/rooms/           room lifecycle, stream decoding, and map mechanics
src/game/items/           collection effects, inventory, key, and door progression
src/game/flow/            new-game, main-loop, attract, death, and exit control
src/game/demon_mirror/    schedule, allocation, placement, and activation
src/game/ending/          ending sequence and special-room support
src/game/timer/           countdown, display, and timer item effects
src/game/transitions/     room-entry orbit positioning and scaling
src/graphics/ppu/         buffered/direct PPU services and nametable clearing
src/graphics/rooms/       RoomMap, nametable-frame, and cell rendering
src/graphics/hud/         gameplay, score, and fireball display producers
src/data/rooms/           room metadata plus block, enemy, and item streams
src/data/objects/         animation and motion definition banks
src/data/enemies/         enemy type and record-pointer tables
src/data/static_layout.asm compact tables and byte-identity filler segments
